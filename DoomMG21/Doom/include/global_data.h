...
//
    ...
    byte *linesChangeableTextureIndex; // 2021-03-13: forgot that switches have changeable textures...
    byte *switch_texture_top;
    byte *switch_texture_mid;
    byte *switch_texture_bot;
