...
void P_PlayerInSpecialSector(player_t *player)
{
    ...
    sector = getMobjSubesctor(player->mo)->sector;
        ...
        if (_g->buttonlist[i].btimer)
        {
            ...
            if (!_g->buttonlist[i].btimer)
            {
                switch (_g->buttonlist[i].where)
                {
                     ...
                     */
                    case top:
                        _g->switch_texture_top[_g->buttonlist[i].line->lineno] = _g->buttonlist[i].btexture;
                        break;

                    case middle:
                        _g->switch_texture_mid[_g->buttonlist[i].line->lineno] = _g->buttonlist[i].btexture;
                        break;

                    case bottom:
                        _g->switch_texture_bot[_g->buttonlist[i].line->lineno] = _g->buttonlist[i].btexture;
                        break;
                    default:
                        break;
                }
