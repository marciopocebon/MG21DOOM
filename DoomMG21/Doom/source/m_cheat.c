...
{
{ "Chainsaw", CHEAT_SEQ(KEYD_MENU, KEYD_UP, KEYD_UP, KEYD_LEFT, KEYD_MENU, KEYD_USE, KEYD_USE, KEYD_UP), cheat_choppers },
...
{ "Ammo & Keys", CHEAT_SEQ(KEYD_MENU, KEYD_LEFT, KEYD_USE, KEYD_RIGHT, KEYD_USE, KEYD_UP, KEYD_MENU, KEYD_UP), cheat_idkfa },
{ "Ammo", CHEAT_SEQ(KEYD_MENU, KEYD_CHGW, KEYD_MENU, KEYD_MENU, KEYD_MENU, KEYD_UP, KEYD_UP, KEYD_LEFT), cheat_ammo },
{ "No Clipping", CHEAT_SEQ(KEYD_MENU, KEYD_DOWN, KEYD_LEFT, KEYD_RIGHT, KEYD_UP, KEYD_DOWN, KEYD_LEFT, KEYD_RIGHT), cheat_noclip },
{ "Invincibility", CHEAT_SEQ(KEYD_MENU, KEYD_CHGW, KEYD_MENU, KEYD_RIGHT, KEYD_LEFT, KEYD_RIGHT, KEYD_MENU, KEYD_MENU), cheat_invincibility },
{ "Berserk", CHEAT_SEQ(KEYD_MENU, KEYD_CHGW, KEYD_MENU, KEYD_UP, KEYD_LEFT, KEYD_MENU, KEYD_RIGHT, KEYD_MENU), cheat_beserk },
{ "Invisibility", CHEAT_SEQ(KEYD_MENU, KEYD_MENU, KEYD_MENU, KEYD_LEFT, KEYD_LEFT, KEYD_MENU, KEYD_LEFT, KEYD_MENU), cheat_invisibility },
{ "Lite-Amp Goggles", CHEAT_SEQ(KEYD_DOWN, KEYD_LEFT, KEYD_RIGHT, KEYD_MENU, KEYD_RIGHT, KEYD_LEFT, KEYD_LEFT, KEYD_RIGHT), cheat_goggles },
{ "Exit Level", CHEAT_SEQ(KEYD_LEFT, KEYD_LEFT, KEYD_LEFT, KEYD_MENU, KEYD_MENU, KEYD_LEFT, KEYD_RIGHT, KEYD_RIGHT), cheat_exit },
//Because Goldeneye!
{ "Enemy Rockets", CHEAT_SEQ(KEYD_MENU, KEYD_MENU, KEYD_MENU, KEYD_MENU, KEYD_RIGHT, KEYD_MENU, KEYD_MENU, KEYD_RIGHT), cheat_rockets },
{ "FPS Counter Ammo", CHEAT_SEQ(KEYD_RIGHT, KEYD_RIGHT, KEYD_MENU, KEYD_UP, KEYD_DOWN, KEYD_MENU, KEYD_LEFT, KEYD_LEFT), cheat_fps },
